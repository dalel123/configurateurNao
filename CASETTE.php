...
<head>
    ...
    <title>Configurateur Porte de garage Séctionnelle à Cassette</title>
</head>
<body>
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <div class="sticky-content text-center info-color text-white" style="position: fixed; width:380px;">
                <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="img/cassettegrandformat1.png" id="divClr" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="img/cassette%20grand%20format%202.png" id="divClr1"   alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="img/cassette%20grand%20format%203.png"  id="divClr2" alt="Third slide">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <a href="#"><img class="card-img-top" id="divClr3" src="img/pdg%20cassette%20250x250.png"  data-toggle="modal" data-target="#image1" alt=""></a>

                    </div>

                    <div class="col-4">
                        <a href="#"><img class="card-img-top" id="divClr4" src="img/pdg%20cassette%20250x250%203.png" data-toggle="modal" data-target="#image2" alt=""></a>

                    </div>


                    <div class="col-4">
                        <a href="#"><img class="card-img-top"  id="divClr5" src="img/pdg%20cassette%20250x250%202.png" data-toggle="modal" data-target="#image3" alt=""></a>
                    ...
                    <div class="card-text" style="padding-left:12%;width: 20em;" id="price">
                        ...
                        <div class="d-flex" >
                            <div id="tab" style="font-weight: bold;color: black;font-size: 25px;border:2px black solid ;width:20.8em;text-align: center;" onchange="tab();prixinitiale()">1199.04
                            </div>
        ...
        <div class="col-6">
            <div class="example-content">
                ...
                <div class="col-8" style="font-weight: bold;font-size: 15px;text-align: center;" id="entete">
                    CONFIGURATEUR PORTE DE GARAGE SECTIONNELLE À CASSETTE<br>
                ...
                <div id="content">
                    ...
                    <!------------------------------------------------Dimension----------------------------------------------------------------------------------------------------->
                    <div class="col-8" style="width: 23rem;height: 15rem;margin-bottom: 10%;text-align: center;margin-left:20%;" id="schema">
                        <img src="img/schéma.jpg"  class="img-fluid">
                    </div>
                ...
                <div id="configHtml" style="display:">
                    <!-------------------------------------------------------PORTILLON-------------------------------------------------------------------------- -->
                    <div class="mt-2">
                        <div class="d-flex"  name="protillon" id="portillonId" value="Portillon Porte Sectionnelle Verticale">
                            <strong> <P>PORTILLON : </P></strong>
                            ...
                            <div class="form-check" style="margin-top:-18px;">
                                <input type="radio" class="custom-radio custom-control-inline" id=port1  value="Oui" name="portillon" onchange="prixportillon();Afficheaccportillon();" >
                                <label class="form-check-label" for="port1">OUI  <img src="img/casette/hublots-07.jpg"  class="img-fluid" /></label>
                            </div>


                            <div class="form-check" style="margin-top:-18px;">
                                <input type="radio" class="custom-radio custom-control-inline" id="port2"  value="Non" name="portillon" onchange="prixsansPortiollon();Afficheaccportillon();" checked >
                                <label class="form-check-label" for="port2">NON  <img src="img/casette/hublots-10.jpg"  class="img-fluid" /> </label>
                            </div>
                        ...
                        <div id="accessPortillon" style="display: none" onchange=" Afficheaccportillon();">
                        <div class="d-flex">
                    ...
                    <ul class="d-flex">
                        ...
                        <li><input  id="hQte" class="form-check-label" min="0" max="4" style="width:50%;display: none ;padding:5px;" onchange="prixHublotRectangle();"></li>
                        <div id="qth" style="color: #ff0504;font-size: 12px;font-weight: bold;"></div>
                        <li><input id="hQte1" class="form-check-label" min="0" max="4" style="width:50%;display: none;padding:5px;" onchange="quantiteHublot1();prixHublotOvale();"></li>
                        <div id="qth1" style="color: #ff0504;font-size: 12px;font-weight: bold;"></div>
                        <li><input  id="hQte2" class="form-check-label" min="0" max="4" style="width:50%;display: none;padding: 5px;" onchange="quantiteHublot2();prixventillation();"></li>
                    </ul>
                    ...
                    <div class="d-flex">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="hublot1" name="hublot" value="hublot rectangulaire" onchange="prixHublotRectangle();hublotAffiche();">
                            <label class="form-check-label" for="hublot1"><img src="img/hublotrectangle.png"/>hublot rectangulaire</label>
                        </div>


                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="hublot2"  name="hublot" value="hublot ovale" onchange="prixHublotOvale();hublotAffiche();" >
                            <label class="form-check-label" for="hublot2"><img src="img/hublotovale.png">Hublot Ovale</label>
                        </div>


                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="hublot3"  name="hublot" value="ventilation" onchange="prixventillation();hublotAffiche();">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card">
                        <a href="#">
                            <img src="img/casette/DROITE.png" class="card-img-top" alt="portillon">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card">
                        <a href="#">
                            <img src="img/casette/GAUCHE.png" class="card-img-top" alt="portillon">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card">
                        <a href="#">
                            <img src="img/casette/CENTRE.png" class="card-img-top" alt="portillon">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card">
                        <a href="#">
                            <img src="img/pdg%20cassette%20250x250.png" class="card-img-top" alt="pdgs" id="image1">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card" id="image2">
                        <a href="#">
                            <img src="img/pdg%20cassette%20250x250%203.png" class="card-img-top" alt="pdgs" >
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="card-deck">
                    <div class="card">
                        <a href="#"  id="image3" >
                            <img src="img/pdg%20cassette%20250x250%202.png"  class="card-img-top" alt="pdgs" >
                        </a>
                    </div>
                </div>
            </div>
...
<script src="scriptCasette.js"></script>
<script>
